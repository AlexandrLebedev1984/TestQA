...
Функционал: Быстрые проверки на открытие всех форм справочников и документов

Как Тестировщик я хочу
открытие форм справочников и документов 
чтобы проверить корректность работы базы  
